...
SELECT * FROM country WERE region = 'Southern Europe' ORDER BY population ASC;
...
SELECT name,code FROM country WHERE = 'SMR';
San Marino | SMR
...
SELECT city.name, city.population FROM "city" WHERE city.population = 91084;



-- She's in ___ Santa Monica |      91084_________________________!